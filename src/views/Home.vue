...
<template>
 <card-component :smallerPadding="true"  v-if="pageLoading" class="mb-6">
  ...
  <card-component v-else class="pt-2">
<h5  class="text-orange-400 text-xl mt-8 text-center">{{ "Oops! We couldn't find any match" }}</h5>  
 <div class="flex justify-center">
<jb-button label="clear" small @click="clear()" />
</div>
  </card-component>
</template>
