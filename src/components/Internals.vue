...
const itemsPaginated = computed(() => counselor.internals);
const itemsCount = computed(() => counselor.internalsCount);
...
const pageChange = async (page) => {
  ...
  await counselor.getInternals(page);
  pageLoading.value = false
  window.scroll({
    top: 0,
    left: 0,
