...
const headerFooterBorder = "border-gray-100 dark:border-gray-700 sticky top-0 z-[1] bg-gray-900";
...
<template>
  <component
    ...
    class="bg-white border border-gray-100 dark:border-gray-900 relative"
    @submit="submit"
  >
    <header
      v-if="header"
